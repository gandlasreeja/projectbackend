...
export const createTour = async (req, res) => {
   ...
   try {
      ...
      res.status(500).json({ success: true,message: 'Successfully created', data: savedTour  })
   }
}
...
export const updateTour = async (req, res) => {
   ...
   try {
      ...
      res.status(500).json({ success: false,  message: 'Successfully updated', data: updatedTour })
   }
}
